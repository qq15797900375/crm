            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (data.success){
                        ...
                        html += '${activity.name}';
                        html += '</b><small style="color: gray;" id="small'+ data.ar.id +'"> ' + data.ar.createTime +' 由 ' + data.ar.createBy + '</small>';
            ...
            success:function (data) {
                ...
                $.each(data,function (i,n) {
                    ...
                    */
                    ...
                    html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>';
                    html += '${activity.name}';
                    html += '</b><small style="color: gray;" id="small'+ n.id +'"> ' + (n.editFlag==0?n.createTime:n.editTime) +' 由 ' + (n.editFlag==0?n.createBy:n.editBy) + '</small>';
                    html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
