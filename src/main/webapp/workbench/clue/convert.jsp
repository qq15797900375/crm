...
String appellation = request.getParameter("appellation"); = ${param.appellation}
String company = request.getParameter("company"); = ${param.company}
String owner = request.getParameter("owner"); = ${param.owner} */
	...
	$(function(){
		...
		$("#convertBtn").click(function () {
			...
			if ($("#isCreateTransaction").prop("checked")){
				...
				//window.location.href = "workbench/clue/convert.do?clueId=${param.id}&money=xx&expectedDate=xxx&name=xxx&stage=xxx&activityId=xxx";
				//以提交表单的方式
				$("#tranForm").submit();
