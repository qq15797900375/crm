<%@ page import="com.myweb.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.myweb.crm.workbench.domain.Tran" %>
...
<%
	...
	Set<String> set = stageToPossibilityMap.keySet();
...
<script type="text/javascript">
	...
	*/
	...
	function changeIcon(stage, i) {
		...
		//如果当前阶段的可能性为零，前七个一定是黑圈，后两个一个红叉，一个黑叉
		...
		//如果当前阶段的可能性为零，前七个是绿圈，绿色标记，黑圈，后两个一定是黑叉
		} else {
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			String currentPossibility = stageToPossibilityMap.get(currentStage);
			...
			if ("0".equals(currentPossibility)){
				...
				for (int i = 0; i <dicValueList.size(); i++) {
					...
					String listPossibility = stageToPossibilityMap.get(listStage);

					//如果遍历出来的阶段的可能性为0，说明的是后两个，一个是红叉，一个是黑叉
